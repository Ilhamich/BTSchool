...
{
    internal class ServicesOfCoursesEntityConfiguration : IEntityTypeConfiguration<ServicesOfCourses>
    {
        public void Configure(EntityTypeBuilder<ServicesOfCourses> entity) 
        {
